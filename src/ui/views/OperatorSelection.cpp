...
namespace Views
{
    ...
    void DrawOperatorSelection(HDC memDC, const RECT& rect)
    {
        ...
        // Mode section
        RECT modeRect = { infoBoxRect.left + sectionWidth + 10, infoBoxRect.top + 5, infoBoxRect.left + 2 * sectionWidth,
                          infoBoxRect.bottom - 5 };
        char modeText[50];
        ...
        // Toggle key section
        RECT toggleRect = { infoBoxRect.left + 2 * sectionWidth + 10, infoBoxRect.top + 5, infoBoxRect.left + 3 * sectionWidth,
                            infoBoxRect.bottom - 5 };
        char toggleText[50];
