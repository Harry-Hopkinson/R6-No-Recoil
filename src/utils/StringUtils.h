...
namespace StringUtils
{
    ...
    /**
     * @brief Gets a weapon name at a specific index from a comma-separated list
     * @param weapons Comma-separated weapon string
     * @param index Index of weapon to retrieve (0-based)
     * @param out Output buffer to store weapon name
